...
{
    // https://stackoverflow.com/questions/18997163/how-can-i-read-the-manifest-of-an-android-apk-file-using-c-sharp-net
    public class AndroidDecompress
    {
        ...
        public string decompressXML(byte[] manifestFileData)
        {
